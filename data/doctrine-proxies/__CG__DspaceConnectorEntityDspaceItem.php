...
namespace DoctrineProxies\__CG__\DspaceConnector\Entity;


/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class DspaceItem extends \DspaceConnector\Entity\DspaceItem implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'item', 'job', 'apiUrl', 'remoteId', 'handle', 'lastModified'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DspaceItem $proxy) {
    ...
    public function setRemoteId($remoteId)
    {
        ...
        return parent::setRemoteId($remoteId);
    }
